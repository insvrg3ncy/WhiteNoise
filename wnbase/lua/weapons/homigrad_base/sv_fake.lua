...
hook.Add("PlayerSwitchWeapon", "whitenoise-weapons", function(ply, oldWep, newWep)
...
function SWEP:CreateFake(ragdoll)
	...
	self:SetFakeGun(ent)
	ent:CallOnRemove("whitenoise-swep", self.RemoveFake, self)
...
hook.Add("AllowPlayerPickup", "whitenoise-weapons-pickup-e", function(ply, ent) if ply.FakeRagdoll or ent.dontPickup then return false end end)