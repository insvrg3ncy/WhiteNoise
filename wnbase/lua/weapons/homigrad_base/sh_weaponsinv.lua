wn.weaponInv = wn.weaponInv or {}
local weaponInv = wn.weaponInv
local ammoType
...
if SERVER then
	...
	hook.Add("Player Spawn", "whitenoise-weapons-inv2", function(ply)
	...
	hook.Add("WeaponEquip", "whitenoise", function(wep, ply)
	...
	hook.Add("PlayerDroppedWeapon", "whitenoise-weaponInv", function(ply, wep)
		weaponInv.Remove(ply, wep)
		weaponInv.Sync(ply)
	end)

	hook.Add("PlayerCanPickupWeapon", "whitenoise-weapons", function(ply, wep)
