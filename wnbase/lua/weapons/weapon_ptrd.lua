...
SWEP.ReloadTime = 2
SWEP.DeploySnd = {"whitenoise/weapons/draw_hmg.mp3", 55, 100, 110}
SWEP.HolsterSnd = {"whitenoise/weapons/hmg_holster.mp3", 55, 100, 110}
SWEP.HoldType = "rpg"
...
function SWEP:PrimaryShootPost()
	...
	local char = wn.GetCurrentCharacter(owner)
	if not char:IsRagdoll() then
		wn.AddForceRag(owner, 2, owner:EyeAngles():Forward() * -10000, 0.5)
		wn.AddForceRag(owner, 0, owner:EyeAngles():Forward() * -10000, 0.5)

		wn.LightStunPlayer(owner,1)
	end
