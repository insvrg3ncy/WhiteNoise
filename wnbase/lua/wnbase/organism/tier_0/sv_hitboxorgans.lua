...
function wn.organism.Trace(pos, dir, size, maxpen, boxs, center, endDis, organs, ricochetable, funcInput, ...)
...
function wn.organism.BlastTrace(pos, size, dmg, boxs, organs, funcInput, ...)
	local box
	local center
	...
	for i = 1, #boxs do
		...
		--size = size * 999
		local amt = dist / size * (1 - (organs[box[6]] and organs[box[6]][box[7]][2] or 0))
