...
input_list.heart = function(org, bone, dmg, dmgInfo)
	...
	wn.AddHarmToAttacker(dmgInfo, (org.heart - oldDmg) * 10, "Heart damage harm")
...
input_list.liver = function(org, bone, dmg, dmgInfo)
	...
	wn.AddHarmToAttacker(dmgInfo, (org.liver[1] - oldDmg) * 3, "Liver damage harm")
	...
	if org.analgesia < 0.4 and harmed >= 0.2 then
		timer.Simple(0, function()
			if harmed > 0 then
				wn.StunPlayer(org.owner,2)
			else
				wn.LightStunPlayer(org.owner,2)
			end
		end)
	end
...
input_list.stomach = function(org, bone, dmg, dmgInfo)
	...
	wn.AddHarmToAttacker(dmgInfo, (org.stomach - oldDmg) * 2, "Stomach damage harm")
...
input_list.intestines = function(org, bone, dmg, dmgInfo)
	...
	wn.AddHarmToAttacker(dmgInfo, (org.intestines - oldDmg) * 2, "Intestines damage harm")
...
input_list.brain = function(org, bone, dmg, dmgInfo)
	...
	wn.AddHarmToAttacker(dmgInfo, (org.brain - oldDmg) * 15, "Brain damage harm")
...
local function hitArtery(artery, org, dmg, dmgInfo, boneindex, dir, hit)
	...
	if artery ~= "arteria" then
		wn.AddHarmToAttacker(dmgInfo, 4, "Random artery punctured harm")//((1 - org[artery]) - math.max((1 - org[artery]) - dmg,0)) / 4
	else
		if org.isPly and not org.otrub then
			org.owner:Notify(table.Random(arteryMessages), true, "arteria", 0)
		end
		
		wn.AddHarmToAttacker(dmgInfo, 15, "Carotid artery punctured harm")
	end
...
input_list.lungsL = function(org, bone, dmg, dmgInfo)
	...
	wn.AddHarmToAttacker(dmgInfo, (dmg * 0.25), "Lung left damage harm")
...
input_list.lungsR = function(org, bone, dmg, dmgInfo)
	...
	wn.AddHarmToAttacker(dmgInfo, (dmg * 0.25), "Lung right damage harm")
...
input_list.trachea = function(org, bone, dmg, dmgInfo)
	...
	wn.AddHarmToAttacker(dmgInfo, (org.trachea - oldDmg) * 8, "Trachea damage harm")
