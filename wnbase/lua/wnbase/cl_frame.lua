...
local PANEL = {}
--[[
wn.VGUI.SecondaryColor = Color(155,0,0,240)
wn.VGUI.BackgroundColor = Color(25,25,35,220)]]
local color_blacky = Color(240,240,240,220)
local color_reddy = Color(200,200,200,240)
...
function PANEL:Paint(w,h)
    ...
    wn.DrawBlur(self, self.BlurStrengh)
