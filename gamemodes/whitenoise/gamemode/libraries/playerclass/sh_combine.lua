...
local combine_subclasses = {
    default = {
        ...
        loadout = {
            ...
            {
                weapon = "weapon_hg_grenade_hl2grenade",
                count = 1
            },
            {
...
function CLASS.On(self, bNoEquipment)
    ...
    wn.GiveRole(self, self.leader and "Leader" or "Soldier", Color(89,230,255))
...
if SERVER then
    hook.Add("WN_PlayerFootstep","Combine_footsteps",function(ply)
        local chr = wn.GetCurrentCharacter(ply)
    ...
    hook.Add("WN_PlayerCanHearPlayersVoice","CombineRadio",function(listener,talker)
...
if CLIENT then
    ...
    hook.Add("WN_NoSoundproof","CombineNoSoundproof",function(pPly, lply)
