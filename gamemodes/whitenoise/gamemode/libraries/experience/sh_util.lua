...
local SHTable = wn.Experience

function wn.Experience.GetAwards( self )
...
function plyMeta:GetAwards()
    ...
    return wn.Experience.GetAwards( self )
end
...
if SERVER then
    ...
    hook.Add("PlayerDeath","WN_GiveKills", function(ply)
    ...
    net.Receive( "get_svPData", function()
        ...
        if wn.Experience.OpenedAccount then
            wn.Experience.OpenedAccount:Udpate(ent)
        end
    end)
end