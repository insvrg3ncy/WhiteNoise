...
function PANEL:Init()
    ...
    self.MainInfo = vgui.Create("WN_ExpPanel",self)
...
function PANEL:SetPlayer(ply)
    ...
    for i,stats in pairs(Statics) do
        ...
        Stat:SetFont("WN_InterfaceMedium")
    end
end
...
vgui.Register( "WN_AccountFrame", PANEL, "ZFrame" )


--vgui.Create("WN_AccountFrame"):MakePopup()