...
util.AddNetworkString("WN_Defense_commander_points")
util.AddNetworkString("WN_Defense_commander_notification")
util.AddNetworkString("WN_Defense_player_role_assigned")
...
function MODE:AssignPlayerRoles()
    ...
    if commander then
        ...
        net.Start("WN_Defense_player_role_assigned")
...
function MODE:GiveEquipment()
    ...
    for _, ply in ipairs(player.GetAll()) do
        ...
        pcall(function()
            ...
            wn.GiveRole(ply, "Refugee", Color(255, 150, 0))
        end)
