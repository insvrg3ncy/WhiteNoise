...
util.AddNetworkString("WN_Defense_admin_wave_menu")
util.AddNetworkString("WN_Defense_admin_wave_skip")


concommand.Add("defense_waves_admin", function(ply, cmd, args)
    if not HasAccess(ply) then
        ply:ChatPrint("nah uh")
        return
    end
    ...
    net.Start("WN_Defense_admin_wave_menu")
...
net.Receive("WN_Defense_admin_wave_skip", function(len, ply)
