...
function CreateCommanderMenu()
    ...
    orderButton.DoClick = function()
        ...
        net.Start("WN_Defense_commander_purchase")
...
net.Receive("WN_Defense_commander_menu", function()
    availableItems = net.ReadTable()
    CreateCommanderMenu()
end)


net.Receive("WN_Defense_commander_notification", function()
...
net.Receive("WN_Defense_prepphase", function()
