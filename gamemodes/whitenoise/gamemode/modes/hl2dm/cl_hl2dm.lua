...
function MODE:HUDPaint()
    ...
    draw.SimpleText("ZBattle | Half-Life 2 Deathmatch", "WN_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    ...
    draw.SimpleText("You are " .. role_data.name, "WN_HomicideMediumLarge", sw * 0.5, sh * 0.5, role_data.color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)

    local objective_color = team_data.color2

    objective_color.a = 255 * fade

    draw.SimpleText(role_data.objective, "WN_HomicideMedium", sw * 0.5, sh * 0.9, objective_color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
